...
function showOrderPopup(productNameId, itemPrice) {
    ...
    document.getElementById("item").value = document.getElementById(productNameId).innerText;
...
function submitOrder() {
    ...
    let whatsappNumber = "085738187967";
    let whatsappLink = `https://api.whatsapp.com/send?phone=${whatsappNumber}&text=Order%20${itemName}%0A${message}`;
